...
var map = {
	...
	"./portfolio_controller.js": "./src/js/controllers/portfolio_controller.js",
	...
	"./video_controller.js": "./src/js/controllers/video_controller.js"
};
...
/***/ "./src/js/controllers/portfolio_controller.js":
/*!****************************************************!*\
  !*** ./src/js/controllers/portfolio_controller.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./src/js/controllers/video_controller.js":
/*!************************************************!*\
  !*** ./src/js/controllers/video_controller.js ***!
  \************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.init();
      this.playTargets.forEach(function (item) {
        return _this2.play(item);
      });
    }
  }, {
    key: "play",
    value: function play(button) {
      var PAUSE_CLASS = "play--pause";
      var _this = button;
      ...
      _this.addEventListener("click", function () {
        ...
        video.addEventListener("ended", function () {
          ...
          _this.style.display = 'flex'; // _this.classList.remove(PAUSE_CLASS)
        });
      });
    }
  }, {
...
var menuOpenButton = document.querySelector(".menu__button--open");
var menuCloseButton = document.querySelector(".menu__button--close");
...
popups.forEach(function (popup) {
  new _modules_popup_popup__WEBPACK_IMPORTED_MODULE_4__["Popup"](popup);
});
...
jquery__WEBPACK_IMPORTED_MODULE_5___default()(".form").submit(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_5___default.a.ajax({
    ...
    new _modules_popup_popup__WEBPACK_IMPORTED_MODULE_4__["PopupThanks"](thx).openPopup();
    setTimeout(function () {
      // Done Functions
      th.trigger("reset");
    }, 1000);
